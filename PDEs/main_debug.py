...
c_u=-np.square(kx)-np.square(ky)-mu
c_v=-np.square(kx)-np.square(ky)+sigma
...
data = np.column_stack([kx.ravel(), ky.ravel(), f1.ravel(), f2.ravel(), f3.ravel(), f4.ravel()])
np.savetxt("output/fs.dat", data, fmt='%f')
data = np.column_stack([kx.ravel(), ky.ravel(), g1.ravel(), g2.ravel(), g3.ravel(), g4.ravel()])
np.savetxt("output/gs.dat", data, fmt='%f')
data = np.column_stack([kx.ravel(), ky.ravel(), c_u.ravel(), c_v.ravel()])
np.savetxt("output/cs.dat", data, fmt='%f')
data = np.column_stack([kx.ravel(), ky.ravel(), np.abs(f_k).ravel(), np.abs(g_k).ravel()])
np.savetxt("output/0_fk.dat", data, fmt='%f')
data = np.column_stack([kx.ravel(), ky.ravel(), np.abs(f_k_prev).ravel(), np.abs(g_k_prev).ravel()])
np.savetxt("output/0_fk_prev.dat", data, fmt='%f')
data = np.column_stack([x.ravel(), y.ravel(), f_x.ravel(), g_x.ravel()])
np.savetxt("output/0_fx.dat", data, fmt='%f')
...
for i in range(1,t_points+1):
    ...
    if t >= counter:
        ...
        data = np.column_stack([kx.ravel(), ky.ravel(), np.abs(f_k).ravel(), np.abs(g_k).ravel()])
        np.savetxt("output/"+str(counter)+"_fk.dat", data, fmt='%f')
        data = np.column_stack([kx.ravel(), ky.ravel(), np.abs(f_k_prev).ravel(), np.abs(g_k_prev).ravel()])
        np.savetxt("output/"+str(counter)+"_fk_prev.dat", data, fmt='%f')
        data = np.column_stack([x.ravel(), y.ravel(), f_x.ravel(), g_x.ravel()])
        np.savetxt("output/"+str(counter)+"_fx.dat", data, fmt='%f')
        counter+=1
