...
//Computing the intrinsic fequency
...
int main(int argc, char* argv[]) {
	...
	cout << "Floquet multiplies: " << GSL_REAL(gsl_vector_complex_get(floquet_multipliers,0)) << "+j*" << GSL_IMAG(gsl_vector_complex_get(floquet_multipliers,0)) << " " << GSL_REAL(gsl_vector_complex_get(floquet_multipliers,1)) << "+j*" << GSL_IMAG(gsl_vector_complex_get(floquet_multipliers,1))<< endl;
